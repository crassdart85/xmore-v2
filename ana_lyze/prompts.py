...
batch_sentiment = """You are analyzing Tadawul (Saudi Exchange) news articles for stock market sentiment.

Tadawul listed companies (use ONLY these for matching):
{company_list}

Analyze the following {n} articles. For each article, identify any Tadawul companies mentioned and their sentiment.
...
[
    {{"idx": 0, "matches": [{{"symbol": "2222.SR", "company": "Saudi Aramco", "sentiment": "positive", "score": 7}}]}},
  {{"idx": 1, "matches": []}},
  ...
]
Rules:
- Only include companies from the provided Tadawul company list above
...
- Empty matches array if no Tadawul company is mentioned in that article

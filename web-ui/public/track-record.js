...
const I18N = {
  en: {
    ...
    heroTitle: 'Tadawul Stock Predictions — Verified Performance',
    ...
    equityDesc: 'This chart compounds the daily average return of all Xmore signals (blue) against the TASI benchmark return on the same day (grey). The widening gap represents alpha — value generated beyond what the market gave for free.',
    ...
    methodDesc: 'Xmore uses five independent signal engines, each analysing the same stock from a different lens. Their individual signals are weighted into a single consensus score. No single agent controls the outcome — disagreement between agents is flagged as elevated risk.',
  ...
  ar: {
    ...
    pill1: '5 عوامل ذكاء اصطناعي', pill2: 'توافق موزون', pill3: 'أسهم تداول', pill4: 'آلي. محايد.',
    ...
    kpiAlpha: 'متوسط الألفا vs تاسي', kpiAlphaDesc: 'العائد الزائد لكل إشارة فوق المؤشر القياسي',
    kpiBeat: 'تفوّق على المؤشر', kpiBeatDesc: 'إشارات تفوقت على تاسي في نفس اليوم',
    ...
    equityTitle: 'العائد التراكمي: إشارات Xmore مقابل مؤشر تاسي',
    equityDesc: 'يُركّب هذا الرسم البياني متوسط العائد اليومي لجميع إشارات Xmore (باللون الأزرق) مقارنةً بعائد مؤشر تاسي في نفس اليوم (باللون الرمادي). الفجوة المتسعة تمثل الألفا — القيمة المُضافة فوق ما يمنحه السوق مجاناً.',
    legendXmore: 'إشارات Xmore', legendBench: 'مؤشر تاسي',
    ...
    agentML: 'مدرَّب على بيانات تاريخية لأسعار وأحجام وميزات تقنية لأسهم السوق السعودي. يتعلم أنماطاً غير خطية.',
    ...
    agentPerfDesc: 'معدلات النجاح وأعداد الإشارات لكل عامل خلال آخر 30 و90 يوماً. هذه الشفافية تُريك أي طبقة تحليلية تقود الدقة في تداول.',
    topStocksTitle: 'أفضل الأسهم بالألفا المُحقق',
    topStocksDesc: 'أسهم أسفرت فيها إشارات Xmore باستمرار عن عوائد تتجاوز مؤشر تاسي. الحد الأدنى 3 إشارات محسومة.',
    ...
    t1Label: 'ختم زمني قبل السوق', t1Text: 'كل توقع يُولَّد ويُسجَّل قبل افتتاح تداول. وقت التوليد مسجَّل ولا يمكن تعديله.',
    ...
    t4Label: 'عوائد من مصادر السوق', t4Text: 'العوائد الفعلية محسوبة من أسعار إغلاق تداول الرسمية، من مصادر بيانات السوق المتعددة.',
    ...
    riskRows: [
      ...
      { label: 'متوسط الألفا', key: 'avg_alpha_1d', desc: 'متوسط العائد الزائد مقارنة بتاسي لكل إشارة.', negate: false },
    ],
    rollingLabels: { win_rate: 'معدل النجاح', alpha: 'متوسط الألفا', sharpe_ratio: 'شارب', sortino_ratio: 'سورتينو', max_drawdown: 'أقصى تراجع', profit_factor: 'معامل الربح', beat_benchmark: 'تفوّق تاسي', trades: 'إشارات' },
    backtestTitle: 'اختبار السير للأمام — التحقق من عامل التعلم الآلي',
    backtestDesc: 'يخضع عامل RandomForest للتعلم الآلي للتحقق المستقل باستخدام منهجية السير للأمام: يُدرَّب النموذج على بيانات السوق السعودي التاريخية، ثم يُختبر على الفترة التالية غير المرئية — محاكاةً للنشر الفعلي دون انحياز للمستقبل. تُعاد حساب النتائج كل يوم أحد. يعرض هذا القسم دقة خارج العينة والدقة الاتجاهية وربح/خسارة الإشارة الافتراضية لكل سهم.',
    ...
    sectorDesc: 'أي قطاعات تداول يقرأها Xmore بشكل أفضل؟',
  ...
  try {
    ...
    if (footer) {
      ...
      footer.innerHTML = '<span class="tr-chart-stat">Xmore cumulative (Net): <strong>' + (totalXmoreNet > 0 ? '+' : '') + totalXmoreNet.toFixed(2) + '%</strong></span>' +
        '<span class="tr-chart-stat">TASI benchmark: <strong>' + (totalEgx > 0 ? '+' : '') + totalEgx.toFixed(2) + '%</strong></span>' +

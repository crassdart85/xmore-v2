...
const I18N = {
  en: {
    ...
    equityTitle: 'CUMULATIVE RETURN: XMORE SIGNALS vs EGX30 BENCHMARK',
    equityDesc: 'This chart compounds the daily average return of all Xmore signals (blue) against the EGX30 benchmark return on the same day (grey). The widening gap represents alpha — value generated beyond what the market gave for free.',
    legendXmore: 'Xmore Signals', legendBench: 'EGX30 Benchmark',
    ...
    t4Label: 'Market-Sourced Returns', t4Text: 'Actual returns are computed from official EGX closing prices, cross-referenced with multiple market data sources.',

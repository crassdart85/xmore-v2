...
const I18N = {
  en: {
    ...
    heroTitle: 'EGX Stock Predictions — Verified Performance',
    ...
    pill1: '5 Signal Engines', pill2: 'Weighted Consensus', pill3: 'EGX-Listed Stocks', pill4: 'Automated. Unbiased.',
    ...
    equityDesc: 'This chart compounds the daily average return of all Xmore signals (blue) against the EGX 30 benchmark return on the same day (grey). The widening gap represents alpha â€” value generated beyond what the market gave for free.',
  ...
  ar: {
    ...
    pill1: '5 Ø¹ÙˆØ§Ù…Ù„ Ø°ÙƒØ§Ø¡ Ø§ØµØ·Ù†Ø§Ø¹ÙŠ', pill2: 'ØªÙˆØ§ÙÙ‚ Ù…ÙˆØ²ÙˆÙ†', pill3: 'Ø£Ø³Ù‡Ù… Ø§Ù„Ø¨ÙˆØ±ØµØ© Ø§Ù„Ù…ØµØ±ÙŠØ©', pill4: 'Ø¢Ù„ÙŠ. Ù…Ø­Ø§ÙŠØ¯.',
    ...
    kpiAlpha: 'Ù…ØªÙˆØ³Ø· Ø§Ù„Ø£Ù„ÙØ§ vs EGX30', kpiAlphaDesc: 'Ø§Ù„Ø¹Ø§Ø¦Ø¯ Ø§Ù„Ø²Ø§Ø¦Ø¯ Ù„ÙƒÙ„ Ø¥Ø´Ø§Ø±Ø© ÙÙˆÙ‚ Ø§Ù„Ù…Ø¤Ø´Ø± Ø§Ù„Ù‚ÙŠØ§Ø³ÙŠ',
    kpiBeat: 'ØªÙÙˆÙ‘Ù‚ Ø¹Ù„Ù‰ Ø§Ù„Ù…Ø¤Ø´Ø±', kpiBeatDesc: 'Ø¥Ø´Ø§Ø±Ø§Øª ØªÙÙˆÙ‚Øª Ø¹Ù„Ù‰ EGX30 ÙÙŠ Ù†ÙØ³ Ø§Ù„ÙŠÙˆÙ…',
    ...
    equityTitle: 'Ø§Ù„Ø¹Ø§Ø¦Ø¯ Ø§Ù„ØªØ±Ø§ÙƒÙ…ÙŠ: Ø¥Ø´Ø§Ø±Ø§Øª Xmore Ù…Ù‚Ø§Ø¨Ù„ Ù…Ø¤Ø´Ø± EGX 30',
    equityDesc: 'ÙŠÙØ±ÙƒÙ‘Ø¨ Ù‡Ø°Ø§ Ø§Ù„Ø±Ø³Ù… Ø§Ù„Ø¨ÙŠØ§Ù†ÙŠ Ù…ØªÙˆØ³Ø· Ø§Ù„Ø¹Ø§Ø¦Ø¯ Ø§Ù„ÙŠÙˆÙ…ÙŠ Ù„Ø¬Ù…ÙŠØ¹ Ø¥Ø´Ø§Ø±Ø§Øª Xmore (Ø¨Ø§Ù„Ù„ÙˆÙ† Ø§Ù„Ø£Ø²Ø±Ù‚) Ù…Ù‚Ø§Ø±Ù†Ø©Ù‹ Ø¨Ø¹Ø§Ø¦Ø¯ Ù…Ø¤Ø´Ø± EGX 30 ÙÙŠ Ù†ÙØ³ Ø§Ù„ÙŠÙˆÙ… (Ø¨Ø§Ù„Ù„ÙˆÙ† Ø§Ù„Ø±Ù…Ø§Ø¯ÙŠ). Ø§Ù„ÙØ¬ÙˆØ© Ø§Ù„Ù…ØªØ³Ø¹Ø© ØªÙ…Ø«Ù„ Ø§Ù„Ø£Ù„ÙØ§ â€” Ø§Ù„Ù‚ÙŠÙ…Ø© Ø§Ù„Ù…ÙØ¶Ø§ÙØ© ÙÙˆÙ‚ Ù…Ø§ ÙŠÙ…Ù†Ø­Ù‡ Ø§Ù„Ø³ÙˆÙ‚ Ù…Ø¬Ø§Ù†Ø§Ù‹.',
    legendXmore: 'Ø¥Ø´Ø§Ø±Ø§Øª Xmore', legendBench: 'Ù…Ø¤Ø´Ø± EGX 30',
    ...
    agentML: 'Ù…Ø¯Ø±ÙŽÙ‘Ø¨ Ø¹Ù„Ù‰ Ø¨ÙŠØ§Ù†Ø§Øª ØªØ§Ø±ÙŠØ®ÙŠØ© Ù„Ø£Ø³Ø¹Ø§Ø± ÙˆØ£Ø­Ø¬Ø§Ù… ÙˆÙ…ÙŠØ²Ø§Øª ØªÙ‚Ù†ÙŠØ© Ù„Ø£Ø³Ù‡Ù… Ø§Ù„Ø¨ÙˆØ±ØµØ© Ø§Ù„Ù…ØµØ±ÙŠØ©. ÙŠØªØ¹Ù„Ù… Ø£Ù†Ù…Ø§Ø·Ø§Ù‹ ØºÙŠØ± Ø®Ø·ÙŠØ©.',
    ...
    agentPerfDesc: 'Ù…Ø¹Ø¯Ù„Ø§Øª Ø§Ù„Ù†Ø¬Ø§Ø­ ÙˆØ£Ø¹Ø¯Ø§Ø¯ Ø§Ù„Ø¥Ø´Ø§Ø±Ø§Øª Ù„ÙƒÙ„ Ø¹Ø§Ù…Ù„ Ø®Ù„Ø§Ù„ Ø¢Ø®Ø± 30 Ùˆ90 ÙŠÙˆÙ…Ø§Ù‹. Ù‡Ø°Ù‡ Ø§Ù„Ø´ÙØ§ÙÙŠØ© ØªÙØ±ÙŠÙƒ Ø£ÙŠ Ø·Ø¨Ù‚Ø© ØªØ­Ù„ÙŠÙ„ÙŠØ© ØªÙ‚ÙˆØ¯ Ø§Ù„Ø¯Ù‚Ø© ÙÙŠ Ø§Ù„Ø¨ÙˆØ±ØµØ© Ø§Ù„Ù…ØµØ±ÙŠØ©.',
    topStocksTitle: 'Ø£ÙØ¶Ù„ Ø§Ù„Ø£Ø³Ù‡Ù… Ø¨Ø§Ù„Ø£Ù„ÙØ§ Ø§Ù„Ù…ÙØ­Ù‚Ù‚',
    topStocksDesc: 'Ø£Ø³Ù‡Ù… Ø£Ø³ÙØ±Øª ÙÙŠÙ‡Ø§ Ø¥Ø´Ø§Ø±Ø§Øª Xmore Ø¨Ø§Ø³ØªÙ…Ø±Ø§Ø± Ø¹Ù† Ø¹ÙˆØ§Ø¦Ø¯ ØªØªØ¬Ø§ÙˆØ² Ù…Ø¤Ø´Ø± EGX 30. Ø§Ù„Ø­Ø¯ Ø§Ù„Ø£Ø¯Ù†Ù‰ 3 Ø¥Ø´Ø§Ø±Ø§Øª Ù…Ø­Ø³ÙˆÙ…Ø©.',
    ...
    t1Label: 'Ø®ØªÙ… Ø²Ù…Ù†ÙŠ Ù‚Ø¨Ù„ Ø§Ù„Ø³ÙˆÙ‚', t1Text: 'ÙƒÙ„ ØªÙˆÙ‚Ø¹ ÙŠÙÙˆÙ„ÙŽÙ‘Ø¯ ÙˆÙŠÙØ³Ø¬ÙŽÙ‘Ù„ Ù‚Ø¨Ù„ Ø§ÙØªØªØ§Ø­ Ø§Ù„Ø¨ÙˆØ±ØµØ© Ø§Ù„Ù…ØµØ±ÙŠØ©. ÙˆÙ‚Øª Ø§Ù„ØªÙˆÙ„ÙŠØ¯ Ù…Ø³Ø¬ÙŽÙ‘Ù„ ÙˆÙ„Ø§ ÙŠÙ…ÙƒÙ† ØªØ¹Ø¯ÙŠÙ„Ù‡.',
    ...
    t4Label: 'Ø¹ÙˆØ§Ø¦Ø¯ Ù…Ù† Ù…ØµØ§Ø¯Ø± Ø§Ù„Ø³ÙˆÙ‚', t4Text: 'Ø§Ù„Ø¹ÙˆØ§Ø¦Ø¯ Ø§Ù„ÙØ¹Ù„ÙŠØ© Ù…Ø­Ø³ÙˆØ¨Ø© Ù…Ù† Ø£Ø³Ø¹Ø§Ø± Ø¥ØºÙ„Ø§Ù‚ Ø§Ù„Ø¨ÙˆØ±ØµØ© Ø§Ù„Ù…ØµØ±ÙŠØ© Ø§Ù„Ø±Ø³Ù…ÙŠØ©ØŒ Ù…Ù† Ù…ØµØ§Ø¯Ø± Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ø³ÙˆÙ‚ Ø§Ù„Ù…ØªØ¹Ø¯Ø¯Ø©.',
    ...
    disclaimerText: 'ØªØ¬Ù…Ø¹ Ù…Ù‚Ø§ÙŠÙŠØ³ Ø§Ù„Ø£Ø¯Ø§Ø¡ Ø¨ÙŠÙ† Ø§Ù„ØªÙˆÙ‚Ø¹Ø§Øª Ø§Ù„Ø­ÙŠØ© Ù‚Ø¨Ù„ Ø§Ù„Ø³ÙˆÙ‚ (Ù…Ù†Ø° Ù…Ø§Ø±Ø³ 2026) ÙˆØ¥Ø´Ø§Ø±Ø§Øª Ø§Ù„Ù…Ø­Ø§ÙƒØ§Ø© Ø§Ù„ØªØ§Ø±ÙŠØ®ÙŠØ© Ø§Ù„Ù…ÙÙˆÙ„ÙŽÙ‘Ø¯Ø© Ø¨Ù†ÙØ³ Ù…Ù†Ø·Ù‚ Ø§Ù„Ø¹ÙˆØ§Ù…Ù„ Ø¹Ù„Ù‰ Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ø¨ÙˆØ±ØµØ© Ø§Ù„Ù…ØµØ±ÙŠØ© Ø§Ù„Ø³Ø§Ø¨Ù‚Ø©. Ø¥Ø´Ø§Ø±Ø§Øª Ø§Ù„Ù…Ø­Ø§ÙƒØ§Ø© Ù…ÙÙˆØ³ÙŽÙ…Ø© Ø¨Ù€ SIM ÙÙŠ Ø³Ø¬Ù„ Ø§Ù„ØªÙˆÙ‚Ø¹Ø§Øª. Ù„Ù… ØªÙØ³ØªØ®Ø¯Ù… Ø£ÙŠ Ø¨ÙŠØ§Ù†Ø§Øª Ø£Ø³Ø¹Ø§Ø± Ù…Ø³ØªÙ‚Ø¨Ù„ÙŠØ© ÙÙŠ Ø£ÙŠ Ù…Ø±Ø­Ù„Ø© â€” Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø¥Ø´Ø§Ø±Ø§Øª ØªØ¹ÙƒØ³ Ø§Ù„Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø§Ù„Ù…ØªØ§Ø­Ø© Ù‚Ø¨Ù„ Ø§ÙØªØªØ§Ø­ Ø§Ù„Ø³ÙˆÙ‚ ÙÙ‚Ø·. Ø§Ù„Ø£Ø¯Ø§Ø¡ Ø§Ù„Ø³Ø§Ø¨Ù‚ Ù„Ø§ ÙŠØ¶Ù…Ù† Ø§Ù„Ù†ØªØ§Ø¦Ø¬ Ø§Ù„Ù…Ø³ØªÙ‚Ø¨Ù„ÙŠØ©. Ø¥Ø´Ø§Ø±Ø§Øª Xmore Ù„Ù„Ø£ØºØ±Ø§Ø¶ Ø§Ù„Ù…Ø¹Ù„ÙˆÙ…Ø§ØªÙŠØ© ÙˆÙ„Ø§ ØªØ´ÙƒÙ„ Ù†ØµÙŠØ­Ø© Ø§Ø³ØªØ«Ù…Ø§Ø±ÙŠØ©.',
    ...
    sectorDesc: 'Ø£ÙŠ Ù‚Ø·Ø§Ø¹Ø§Øª Ø¨ÙˆØ±ØµØ© Ù…ØµØ± ÙŠÙ‚Ø±Ø£Ù‡Ø§ Xmore Ø¨Ø´ÙƒÙ„ Ø£ÙØ¶Ù„ØŸ',
...
async function loadSummary() {
  try {
    ...
    if (isNewShape) {
      ...
      if (dr && since && last) {
        dr.textContent = `Data range: ${fmtDate(since)} â†’ ${fmtDate(last)} Â· ${total} live signals`;
      }
      ...
      if (dr && g.first_prediction && g.last_prediction) {
        dr.textContent = `Data range: ${fmtDate(g.first_prediction)} â†’ ${fmtDate(g.last_prediction)} Â· ${g.total_predictions} signals`;
      }
...
async function renderRolling(rolling) {
  ...
  container.innerHTML = windows.map(([key, label]) => {
    ...
    const rows = [
      ...
      { label: labels.beat_benchmark,val: beat,     fmt: v => v != null ? v + '%' : 'â€”',              cls: beat == null ? '' : beat >= 50 ? 'pos' : 'neg' },
      { label: labels.alpha,         val: alpha,    fmt: v => v != null ? fmtPct(v, 3) : 'â€”',         cls: colorClass(alpha) },
      { label: labels.sharpe_ratio,  val: sharpe,   fmt: v => v != null ? fmt(v, 2) : 'â€”',            cls: colorClass(sharpe) },
      { label: labels.sortino_ratio, val: sortino,  fmt: v => v != null ? fmt(v, 2) : 'â€”',            cls: colorClass(sortino) },
      { label: labels.max_drawdown,  val: maxDD,    fmt: v => v != null ? '-' + fmt(v, 2) + '%' : 'â€”',cls: 'neg' },
      { label: labels.profit_factor, val: pf,       fmt: v => v != null ? fmt(v, 2) : 'â€”',            cls: colorClass(pf != null ? pf - 1 : null) },
    ];
    return `<div class="tr-rolling-card">
      <div class="tr-rolling-card-title">${label} â€” ${trades} signals</div>
...
function toggleTrack(btn) {
  ...
  if (idx === -1) {
    ...
    btn.querySelector('span').textContent = 'â—Ž';
...
function renderTrackerPanel() {
  ...
  if (!tracked.length) {
    body.innerHTML = `<div style="padding:24px 16px;text-align:center;color:rgba(255,255,255,0.3);font-size:12px">Click â—Ž on any signal to track it</div>`;
...
function initTracker() {
  ...
  if (clearBtn) clearBtn.addEventListener('click', () => {
    ...
    renderTrackerPanel();
    updateTrackerBadge();
    document.querySelectorAll('.track-btn.tracked').forEach(b => { b.classList.remove('tracked'); const s = b.querySelector('span'); if(s) s.textContent='â—Ž'; });
  });
  renderTrackerPanel();
  updateTrackerBadge();
}
...
async function loadSectorAccuracy() {
  ...
  try {
    ...
    <div class="tr-sector-legend">
      ...
      <span style="margin-left:12px;color:#888">Â· return = avg 1D pct</span>
    </div>`;

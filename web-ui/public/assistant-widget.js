(function () {
    ...
    const I18N = {
        en: {
            ...
            placeholder: 'Ask about EGX stocks, sectors, or macro...',
            welcome: "Hello! I'm your EGX research assistant. Ask me about Egyptian stocks, news, or market context.",
            thinking: 'Thinking...',
        ...
        ar: {
            ...
            placeholder: 'اسأل عن أسهم البورصة المصرية أو القطاعات أو الماكرو...',
            welcome: 'مرحباً! أنا مساعد البحث للبورصة المصرية. اسألني عن الأسهم المصرية أو الأخبار أو سياق السوق.',
            thinking: 'جاري التفكير...',
            macroChip: 'ملخص ماكرو',
            moversChip: 'الأكثر حركة',
            buysChip: 'إشارات الشراء',
            moversPrompt: 'ما هي أكثر الأسهم حركة في البورصة المصرية اليوم؟',
            buysPrompt: 'ما هي أقوى إشارات الشراء اليوم؟',
            macroPrompt: 'ملخص ماكرو البورصة المصرية لليوم',
            sendLabel: 'إرسال',
